...
## Key Information
- **Cheating detection**: Used in [[SWE-rebench]] to discover models accessing future git history, using web patch tools, and scraping GitHub with curl to copy solutions.
...
## Related
- [[SWE-rebench]] — benchmark using trajectory analysis
