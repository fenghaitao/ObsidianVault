...
- Odersky also maps distinct language niches: Rust for embedded/low-memory work, Go as an intentionally small server language, Zig for clean comptime inlining, and Python as a glue language — with Scala's always-on type system as the differentiating guarantee.
