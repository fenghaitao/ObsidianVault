...
## Related
- [[LLMAsJudge]] — the automated evaluation technique validated through inter-annotator agreement
- [[HumanInTheLoopEvaluation]] — validating LLM judges against human labels
- [[RubricBased Evaluation]] — the rubric framework enabling consistent agreement
