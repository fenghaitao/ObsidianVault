---
title: "Token Expenditure Estimation"
type: concept
tags: [concept, cost-management, ai-economics, process]
...
- **Decision Framework**: Instead of "is this worth an engineer's time?", the question becomes "is this worth the token expenditure?"
- **Relationship to LDD**: The [[Lightweight Design Document]] may eventually include token cost estimates alongside design decisions
- **Economic Shift**: As agent-driven development matures, the cost model shifts from salary-based (fixed) to consumption-based (variable)
