...
- **Agent to Commerce Protocol (ACP)**: Co-developed with [[Stripe]] a standard set of APIs and objects for structured, deterministic checkout flows between AI agents and e-commerce sellers. Enables programmatic product catalog expression, cart state relay, and payment integration via shared payment tokens.
...
- [[GitHubCopilot]] — powered by OpenAI Codex
...
- [[Sam Altman]] — referenced for "steamrolling" concept
...
- [[summary-20260606 - Building safe Payment Infrastructure for the autonomous economy — Steve Kaliski, Stripe]] — source (ACP co-development)
- [[Agent to Commerce Protocol]] — co-developed with Stripe
- [[Stripe]] — ACP partner
- [[Shared Payment Tokens]] — payment credential used in ACP