...
Threads is Meta's text-first social network launched in 2023, built on Instagram in roughly five to six months to capitalize on the window created by Musk's acquisition of Twitter. Sash was one of its early prototype engineers.

## Key Information

- Started as a secret, employee-gated project inside Instagram, prototyped in London over Christmas break
- Sash wired a Mastodon instance to an internal Instagram server and built a text-only Instagram feed (images stripped, captions enlarged) as the first working demo
- A working prototype created momentum where 500 docs couldn't — it showed the direction concretely and got people to jump on
...
- [[Sash]] — early prototype engineer
- [[Adam Mosseri]] — Instagram CEO (related to the decentralized creator exploration)
