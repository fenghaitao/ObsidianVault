...
## Definition
Flux is the model family from Black Forest Labs, spanning text-to-image generation, image editing, multi-reference editing, and real-time interactive generation. The family represents BFL's stepwise progression toward visual intelligence.

## Key Information
- **Flux 1** (August 2024): First breakthrough, text-to-image only, laptop-runnable, best anatomy compared to larger models, most liked model on Hugging Face at launch
