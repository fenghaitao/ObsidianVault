...
Palo Alto Networks is the world's largest cybersecurity company. It sought an AI coding solution that accelerated its global engineering organization while prioritizing safety and security, since developers spent 30-35% of their time in initial development — precisely where the most critical bugs emerged.

## Key Information

- After evaluating multiple providers, chose Claude on [[VertexAI|Google Cloud's Vertex AI]] for its coding performance, security standards, and integration.
...
- [[VertexAI]] — the deployment platform Palo Alto Networks chose
