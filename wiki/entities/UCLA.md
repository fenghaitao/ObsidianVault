...
UCLA (University of California, Los Angeles) is a public research university. Ryan L. Peterman attended UCLA, where he studied Computer Science and Engineering.

## Key Information

- Ryan Peterman grew up in Orange County, Southern California, with no AP Computer Science offered at his school
- At UCLA, Ryan started as an undeclared engineer, declared as Electrical Engineer, then switched to Computer Science and Engineering in his junior year
- The switch from EE to CS was relatively smooth because there was a lot of overlap between the two programs — he could reuse his EE upper division courses
- Ryan was part of an EE club called IEEE, where he built a side project: an occupancy sensor using a Raspberry Pi that tracked which officers were in the lab via their devices' MAC addresses
- UCLA's name helped Ryan get interview opportunities with all the biggest tech companies for full-time recruiting
...
- [[Ryan L. Peterman]] — attended UCLA
- [[Amazon]] — recruited at UCLA
- [[Bloomberg]] — recruited at UCLA
- [[summary-20250501 - Industry Secrets We Wish We Knew Before Graduating (Staff Engs Talk at UCLA)]] — source summary
- [[Ryan L. Peterman]] — gave a talk at UCLA
