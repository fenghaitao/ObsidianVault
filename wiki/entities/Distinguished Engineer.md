...
Distinguished Engineer is a senior individual-contributor engineering title that Bryan Cantrill reached at Sun Microsystems, and which Michael Bolin contrasts with Meta's E8/E9 "principal"-to-"distinguished"-style levels.

## Key Information

- Cantrill suspects the MTS → Staff Engineer → Senior Staff Engineer → Distinguished Engineer ladder may have originated at Sun or Xerox PARC.
- At Sun, becoming a Distinguished Engineer had two paths: promotion via a political vote by existing DEs (a "country club"), or popping in the side via acqui-hire (a small company's CTO demanding a DE title).
...
- [[Michael Bolin]] — reached principal (E8) at Meta
- [[Sun Microsystems]] — the company whose DE process he dissects
- [[Greg Papadopoulos]] — presented his DE case
