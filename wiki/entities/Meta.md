...
### Adam Ernst's Meta Chapter ([[summary-20260209 - Meta Distinguished Eng (IC9)： Influencing Engs, Failures, and Learnings ｜ Adam Ernst]])

- Adam Ernst is a Distinguished Engineer (IC9) at Meta who built company-wide iOS infrastructure: the Core Data replacement ("mem models"), ComponentKit, and the failed ComponentScript.
- Joined Facebook in 2012 as an E5, weeks before the IPO, during the native-code rewrite; all iOS engineers then fit in one conference room.
- Reviewed ~1,600 diffs in six months and treated code review as an organic way to influence engineers.

### John Myles White's Meta Chapter
- Was a director of engineering on PyTorch and Meta Superintelligence Labs (MSL); "very bullish" on Meta as a stockholder (run effectively for the bottom line) but "very bearish" on being an employee — "a much more stressful time to be an employee there than before."
- Attributes the stress to the oversupplied engineering labor market and the possibility of layoffs ("the number one emotional thing that causes people stress").
- AI infra had a promotion-obsessed culture — "there was not a single person... whose first and foremost goal wasn't promotion" — which monetization reinforced by hiring people with "a very detailed plan of work you will do in order to get promoted."
- Joined a "data science" team that split into core data science and data science infrastructure; the "Emotional Contagion in Social Networks" PNAS paper became a PR disaster.
- Was one of the main developers of Deltoid 3, Meta's A/B testing framework.

### David Ronca's Meta Chapter ([[summary-20260216 - Retired Netflix Eng Director： Leetcode, Regrets, Hiring Stories]])

- Joined Meta in late July 2019 to lead a ~55-person video-processing team after leading Netflix's encoding team.
- His team kept Facebook/Instagram video running when COVID made "every day New Year's Eve" in traffic.
- Valued Meta's PSC/calibration process for turning individual credit into documented, argued, on-paper impact (in contrast with Netflix's team-only credit).
- Recalled Meta's rocking-horse poster: "don't mistake motion for progress."

### Austin McDonald's Hiring Chapter ([[summary-20260316 - Meta Hiring Lead： Avoid Downleveling, Liars, Passing OpenAI And Anthropic Interviews]])

- He was a Meta hiring committee member who led iOS and Android recruiting across the company and conducted hundreds of interviews.
- Meta's five behavioral signal areas are driving results, embracing ambiguity, resolving conflicts, growing continuously, and communicating effectively (distinct from Meta's five company values).
- Staff-level hiring requires two system-design interviews; principal and distinguished candidates get added behavioral interviews plus a project deep-dive.
- Hiring committees are consensus-driven bodies of engineers and engineering managers; final hire/level decisions go to a group of two or three engineering directors.
- His M2 promotion came from solving recruiting problems — leading the iOS/Android recruiting pipelines, improving diversity hiring through better interview preparation, and raising candidate-data quality for the applicant tracking system.

### James Everingham's Meta Chapters
- Novi/Libra: James and Kevin Weil were recruited by David Marcus into the crypto mission; the org grew to ~3,500 people but never shipped under political/regulatory pressure — "we probably should have just released it and asked for forgiveness."
- Dev Infra: James ran developer infrastructure (a ~1,000-engineer senior team) and helped build Dev Mate, an agentic platform that went viral internally (every one of 40,000+ engineers wanted an instance).
- That pull led to Guild: "40,000 developers is fun, but it'd be fun to go do this for 40 million."

### Ryan L. Peterman's Departure ([[summary-20260918 - Update on Quitting My Job at Meta]])
- Ryan left Meta late last year to work on his podcast full-time, using a reorg as the trigger and six months of savings as his runway; nine months later the podcast sustains itself.
- He framed the choice as explicitly not about money — "otherwise I would have just stayed at Meta" — and judged it by the freedom to work on passion projects rather than on-paper logic.

## Related
- [[summary-20260406 - Ex-Head of Eng at Instagram： Career Regrets and Learnings ｜ James Everingham]] — source summary
- [[James Everingham]] — Novi and Dev Infra leader
- [[Novi]] — the crypto project
- [[David Marcus]] — recruited him
- [[Dev Agents]] — the agent platform category Guild targets
- [[summary-20260209 - Meta Distinguished Eng (IC9)： Influencing Engs, Failures, and Learnings ｜ Adam Ernst]] — source summary (Adam Ernst)
- [[Adam Ernst]] — IC9 on iOS infrastructure
- [[summary-20260216 - Retired Netflix Eng Director： Leetcode, Regrets, Hiring Stories]] — source summary (David Ronca)
- [[David Ronca]] — video-processing director
...
- [[summary-20260316 - Meta Hiring Lead： Avoid Downleveling, Liars, Passing OpenAI And Anthropic Interviews]] — source summary (hiring)
- [[Austin McDonald]] — hiring committee member and mobile-hiring lead
- [[Hiring Committee]] — Meta's decision body
- [[Leveling Rubric]] — the five signal areas
...
- [[John Myles White]] — PyTorch/MSL engineering director
- [[Meta Superintelligence Labs]] — the AI lab
- [[PyTorch]] — the AI infra org
- [[summary-20260918 - Update on Quitting My Job at Meta]] — source summary (Ryan's departure)
- [[Reorganization]] — the trigger for his exit
- [[Runway]] — the six months of savings that enabled the exit
