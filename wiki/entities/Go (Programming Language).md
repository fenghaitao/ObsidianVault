...
- On cross-language fit: Odersky describes Go as "a language that lags behind" — intentionally small, only now catching up with generics — while praising the uniform style its limits cultivate.
