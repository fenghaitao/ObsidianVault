...
- Install the [Claude GitHub App](https://github.com/apps/claude)for your organization
- Navigate to [Admin settings > Claude Code](http://claude.ai/admin-settings/claude-code)and toggle on GitHub Analytics
