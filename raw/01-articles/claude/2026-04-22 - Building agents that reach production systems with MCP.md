...
MCP standardizes how AI agents ([ clients](https://modelcontextprotocol.io/docs/develop/build-client#python)) connect to and work with tools and data sources they need (

[). The server securely exposes a range of capabilities, while the client orchestrates them and manages context. If you’re building an MCP client, make it context-efficient with patterns for progressive disclosure.](https://modelcontextprotocol.io/docs/develop/build-server)

*servers*### Load tool definitions on demand with tool search
